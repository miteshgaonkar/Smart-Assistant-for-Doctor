...
# Heading
w2 = Label(root, justify=LEFT, text="Smart Assistant For Doctors", fg="white", bg="black")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="A Project by Timba INC. ", fg="white", bg="black")
...
tts = gTTS(text="welcome to Smart assistant for Doctors. Please enter the symptoms of the patient", lang='en-au')
tts.save("intro.mp3")
mixer.init()
