...
def DecisionTree():
    ...
    if (h=='yes'):
        ...
        tts = gTTS(text="The patient may be suffering from" + disease[a], lang='en')
        ...
        tts = gTTS(text="Please recheck the symptoms", lang='en')
        tts.save("pcvoice.mp3")
        # to start the file from python
        mixer.init()
        mixer.music.load('pcvoice.mp3')
...
w2 = Label(root, justify=LEFT, text="A Project by Timba INC. ", fg="black", bg="light blue")
...
tts = gTTS(text="welcome to Smart assistant for Doctors. A project by RGIT. Please enter the symptoms of the patient", lang='en')
tts.save("intro.mp3")
mixer.init()
